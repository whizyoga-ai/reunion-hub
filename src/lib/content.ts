...
export const content = {
  en: {
    ...
    heritage: {
      ...
      school: {
        ...
        description: "Our beloved Uttarpara Amarendra Vidyapith, founded in 1939, stands as a testament to educational excellence and cultural richness. For decades, this institution has shaped countless lives, fostering not just academic brilliance but also the values of integrity, creativity, and social responsibility. From these very classrooms and corridors emerged engineers, doctors, teachers, artists, and visionaries who have made their mark across the globe. Today, as we gather for our আড্ডাবাজি, we celebrate not just our reunion, but the enduring legacy of a school that taught us to dream, to achieve, and to never forget our roots."
      }
    },
    ideaBox: {
      title: "Idea Box",
  ...
  bn: {
    ...
    menuSection: {
      title: "ড: প্রদিপ দে'র কৃষি গবেষণাগার 🌾👨‍🔬",
      description: "সাবধান! প্রদিপবাবুর খাদ্য পরীক্ষাগারে স্বাগতম। চাষবাস করেই খাওয়াবো! 🚜✨",
      breakfast: {
        title: "প্রাতঃকালীন চাষাবাদ (সকালের কৃষিকাজ) 🌅🌱",
        items: [
          "প্রদিপবাবুর সকালের ফসল — সবুজের দলের তত্ত্বাবধানে ১০০% জৈব ও ২০০% বিস্ময়কর!",
      ...
      evening: {
        ...
        items: [
          "প্রদিপবাবুর সন্ধ্যার হাল্কা খাবার — বীজ বপন করার পর যা খেতে হয়!",
      ...
      dinner: {
        ...
        items: [
          "প্রদিপবাবুর রাতের খাবার — দিনভরের কৃষিকাজের পুরস্কার!",
          "রাতের খাবারে উচ্চ ফলন আর কম ঝামেলার গ্যারান্টি। হজমের জন্য হাঁটতে হবে না, চাষের কাজই যথেষ্ট ব্যায়াম!",
          "মাঠের সোনালী ধান থেকে রান্নাঘরের সোনালী ভাত — প্রদিপবাবুর ম্যাজিক!",
    ...
    confirmedAttendees: {
      ...
      names: ["তন্ময়", "বাসব", "রাতুল", "শেখরজিৎ", "সুপ্রতিম", "চন্দন", "বিশ্বরঞ্জন", "প্রদীপ", "যোগব্রত", "সুদীপ্ত", "শোভন", "অরুণ", "শ্রীকান্ত", "অমল", "সমীর মন্ডল", "সুব্রত", "সুজয়", "সমর", "উত্তম", "চিরঞ্জীব", "সিদ্ধার্থ", "অনির্বান", "মৃদুল", "স্বরূপ", "সঞ্জয় বণিক", "সোমনাথ"]
    },
    coreCommittee: {
      title: "মূল কমিটি",
