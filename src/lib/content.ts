  ...
  bn: {
    ...
    programSchedule: {
      ...
      schedule: [
        ...
        { time: "সকাল ৯:৩০-১০:৩০", title: "প্রাতঃরাশ", description: "হৃদয়গ্রাহী ব্রেকফাস্ট উপভোগ করুন এবং পুরনো বন্ধুদের সাথে কথা বলুন।" },
        { time: "সকাল ৯:৩০-১১:৩০", title: "পরিচিতি পর্ব / স্কুলে ফেরা", description: "আমাদের স্কুলের দিনের স্মৃতি এবং গল্প শেয়ার করুন।" },
        { time: "সকাল ১১:৩০-দুপুর ১২:০০", title: "স্বাস্থ্য পরীক্ষা", description: "সকলের জন্য একটি দ্রুত স্বাস্থ্য পরীক্ষা অধিবেশন।" },
        { time: "দুপুর ১২:০০-১:৩০", title: "ভবিষ্যৎ পরিকল্পনা / আলোচনা", description: "আসুন আমাদের ভবিষ্যৎ পরিকল্পনা এবং কীভাবে আমরা সংযুক্ত থাকতে পারি তা আলোচনা করি।" },
        { time: "দুপুর ১:৩০-৩:০০", title: "মধ্যাহ্নভোজ", description: "দিনের বাকি কার্যকলাপের জন্য পুনরায় জ্বালানি দেওয়ার জন্য একটি সুস্বাদু মধ্যাহ্নভোজ।" },
        { time: "বিকেল ৩:০০-৪:৩০", title: "মঞ্চে পারফরম্যান্স / কারাওকে / জোকস ইত্যাদি", description: "আপনার প্রতিভা প্রদর্শন করুন অথবা কেবল পারফরম্যান্স উপভোগ করুন।" },
        { time: "বিকেল ৪:৩০-৫:০০", title: "চা/কফি", description: "চা এবং কফির জন্য একটি সংক্ষিপ্ত বিরতি।" },
        { time: "বিকেল ৫:০০-৬:০০", title: "পারফরম্যান্স / কারাওকে / জোকস ইত্যাদি", description: "মজা আরও পারফরম্যান্স এবং বিনোদনের সাথে চলতে থাকে।" },
        { time: "সন্ধ্যা ৬:০০-৬:৩০", title: "সান্ধ্যকালীন জলখাবার", description: "শক্তির মাত্রা উচ্চ রাখতে হালকা নাস্তা।" },
        { time: "সন্ধ্যা ৬:৩০-৮:৩০", title: "পার্টি", description: "আসুন সঙ্গীত এবং নৃত্যের সাথে আমাদের পুনর্মিলন উদযাপন করি।" },
        { time: "রাত ৮:৩০-৯:৩০", title: "রাতের খাবার", description: "একটি भव्य ডিনার এবং স্নেহপূর্ণ বিদায় দিয়ে দিন শেষ করুন।" }
      ],
    },
    registrationForm: {
    ...
    confirmedAttendees: {
      ...
      names: [
        ...
        "বিশ্বরঞ্জন", "প্রদীপ", "যোগব্রত", "সুদীপ্ত", "শোভন", "অরুণ", 
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "অনুষ্ঠানস্থলে সীমিত পার্কিং উপলব্ধ। যানজট কমাতে আমরা সম্ভব হলে কারপুলিং বা গণপরিবহন ব্যবহারের জন্য উৎসাহিত করি।",
        },
        {
          id: "faq-5",
