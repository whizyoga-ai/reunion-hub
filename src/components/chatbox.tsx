...
export function Chatbox({ lang }: ChatboxProps) {
  ...
  const quickResponses = React.useMemo(() => ({
    ...
    coreCommittee: {
      keywords: ['organizer', 'team', 'committee', 'pradip', 'core team', 'core committee', 'আয়োজক', 'দল', 'কমিটি', 'মূল কমিটি', 'প্রদীপ', 'মূল দল'],
      response: lang === 'en'
        ? "👥 Core Committee: Led by Pradip Dey (Team Lead & Menu Scientist), the core committee includes Yogabrata, Pradip, Ratul, Supratim, and Tanmoy. These dedicated alumni are working together to make this ADDABAJI memorable for everyone!"
        : "👥 মূল কমিটি: প্রদীপ দে (দলনেতা ও মেনু বিজ্ঞানী) এর নেতৃত্বে, মূল কমিটিতে রয়েছেন যোগব্রত, প্রদীপ, রাতুল, সুপ্রতিম, এবং তন্ময়। এই নিবেদিতপ্রাণ প্রাক্তনীরা একসাথে কাজ করে এই আড্ডাবাজি সবার জন্য স্মরণীয় করে তুলতে চান!"
    }
  }), [lang]);
